            ...
            <div className="relative z-10 max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-5">
                            ...
                            {uploadedImageUrl ? (
                                ...
                                >
                                    ...
                                    <img
                                        ...
                                        style={{ minHeight: 340, maxHeight: 460 }}
                                    />
                                    {/* Overlay grid */}
                    ...
                    >
                        {/* Class legend card */}
                        <div
                            className="p-4 rounded border border-accent-green/15 flex-1"
                            style={{ background: 'rgba(14,22,40,0.7)', backdropFilter: 'blur(8px)' }}
                        >
                            <div className="flex items-center gap-2 mb-4">
                                <Layers className="w-3.5 h-3.5 text-accent-green/60" />
                        ...
                        >
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <span className="terminal-text text-[10px] text-accent-cyan/50 tracking-widest uppercase">
                                    AI Model
                                </span>
                            </div>
                            <div className="space-y-2">
                                {[
                                    { label: 'Engine', value: 'ISRO AI v3.2.1' },
                                    { label: 'Classes', value: '5 terrain types' },
                                    { label: 'Accuracy', value: '96.7%' },
                                    { label: 'Inference', value: '< 0.2 ms' },
                                ].map(({ label, value }) => (
                                    <div key={label} className="flex items-center justify-between">
                                        <span className="terminal-text text-[10px] text-text-secondary/40 tracking-widest">
                                            {label.toUpperCase()}
                                        </span>
                                        <span className="terminal-text text-[10px] text-text-secondary/80 tracking-wider">
                                            {value}
                                        </span>
                                    </div>
                                ))}
