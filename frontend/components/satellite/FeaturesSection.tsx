  ...
  return (
    <section className="relative py-20 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-accent-cyan/5 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-10 w-72 h-72 bg-accent-blue/5 rounded-full blur-3xl" />
      </div>

      <div className="relative z-10 max-w-6xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16">
            <motion.h2 className="text-4xl md:text-5xl font-bold mb-4 text-text-primary">
              Powerful Features
            </motion.h2>
            <motion.p className="text-text-secondary text-lg max-w-2xl mx-auto">
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="p-4 rounded-lg border border-accent-cyan/20 bg-bg-secondary/60 backdrop-blur-sm"
            >
              <div className="text-2xl md:text-3xl font-bold text-accent-cyan mb-1">{stat.number}</div>
